%% Simulation Practice
% Self learning control of robots with artificial intelligence Martin Geiger 
% Robin Neubauer
...
open_system(mdl)
%% 
% Observations The robot environment provides 44 observations to the agent, 
% each normalized between –1 and 1. These observations are:
%% 
...
% maximum and are aligned perpendicularly to the ground. Actions The agent generates 
% eight actions normalized between –1 and 1. After multiplying with a scaling 
% factor, these correspond to the eight joint torque signals for the revolute 
% joints. The overall joint torque bounds are +/– 10 N·m for each joint. Reward 
...
% Episode Termination During training or simulation, the episode terminates if 
